...
__s32  robin_get_screen_size( __u32 *width_p, __u32 *height_p )
{
    ...
    *width_p  = g_fioctrl( robin_hdis, DISP_CMD_SCN_GET_WIDTH, 0, 0 );
    *height_p = g_fioctrl( robin_hdis, DISP_CMD_SCN_GET_HEIGHT, 0, 0 );
...
{
    return (__disp_output_type_t)g_fioctrl( robin_hdis, DISP_CMD_GET_OUTPUT_TYPE, 0, 0  );
}

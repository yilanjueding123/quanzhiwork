...
__s32	init_screen_lock_res(screen_lock_t *screen_lock)
{
    ...
    GetRes(h_them,
           STYLEID,
           uipara->screen_lock_icon,
           screen_lock->lock_bmp,
    ...
    GetRes(h_them,
           STYLEID,
           uipara->screen_unlock_start_icon,
           screen_lock->unlock_start_bmp,
           uipara->lock_icon_rect.width * uipara->lock_icon_rect.height * 4 + 0x36);
    ...
    GetRes(h_them,
           STYLEID,
           uipara->screen_unlock1_icon,
           screen_lock->unlock1_bmp,
           uipara->lock_icon_rect.width * uipara->lock_icon_rect.height * 4 + 0x36);
    ...
    GetRes(h_them,
           STYLEID,
           uipara->screen_unlock2_icon,
           screen_lock->unlock2_bmp,
           uipara->lock_icon_rect.width * uipara->lock_icon_rect.height * 4 + 0x36);
...
static __s32 ScreenLockWinProc(__gui_msg_t *msg)
{
    ...
    case GUI_MSG_CREATE:
    {
        ...
        ScnLockFont	= GUI_SFT_CreateFont(16, BEETLES_APP_ROOT"res\\fonts\\font16.sft" );

        init_screen_lock_res(screen_lock);

...
****************************************************************************************************
*/
__s32  __dsk_wkm_npl_invalidate_item( __u32 index )
{
    __s32  ret;

    ret = g_fioctrl( dsk_wkm_horc, ORC_CMD_INVALIDATE_ITEM_IN_NPL, (__s32)dsk_wkm_hnpl, (void *)index );
    if( ret != ORC_OK )
    {
...
****************************************************************************************************
*/
__bool __dsk_wkm_npl_item_is_valid( __u32 index )
{
    return g_fioctrl( dsk_wkm_horc, ORC_CMD_IS_VALID_ITEM_IN_NPL, (__s32)dsk_wkm_hnpl, (void *)index );
}

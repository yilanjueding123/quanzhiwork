...
__s32 activity_set_load_para(char *app_name, char *src_name, void *p_arg, __u32 size)			// 设置
{
    __u8 err;
...
__s32 activity_get_load_para(char *app_name, char *src_name, void *p_arg, __u32 size)						// 获取
{
    __u8 err;

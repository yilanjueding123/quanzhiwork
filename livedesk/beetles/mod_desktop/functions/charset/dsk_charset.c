...
****************************************************************************************************
*/
__s32 dsk_set_fs_charset( __epdk_charset_enm_e charset )
{
    esFSYS_setfs( 0, 0, charset, NULL );
...
{
    eLIBs_GetFSCharset("d:\\", (__s32 *)(&fs_charset));
...
****************************************************************************************************
*/
__s32 dsk_set_isn_charset( __epdk_charset_enm_e charset )
{
    isn_charset = charset;

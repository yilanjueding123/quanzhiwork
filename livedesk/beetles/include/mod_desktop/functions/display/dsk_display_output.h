...
****************************************************************************************************
*/
extern __disp_output_type_t  dsk_display_get_output_type( void );
...
****************************************************************************************************
*/
extern __s32  dsk_display_dskfmt2epdkfmt( __lion_disp_format_e format, __disp_output_type_t *output_p );
...
****************************************************************************************************
*/
extern __lion_disp_format_e  dsk_display_epdkfmt2dskfmt( __disp_output_type_t output, __s32 format );
...
****************************************************************************************************
*/
extern __s32  dsk_display_on( __disp_output_type_t output );

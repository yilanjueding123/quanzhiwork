...
extern __s32  dsk_set_contrast(__u32 contrast);
extern __s32  dsk_set_saturation(__u32 saturation);
extern __s32  dsk_set_bright(__u32 bright);
extern __s32  dsk_set_hue(__u32 hue);
#endif
...
****************************************************************************************************
*/
extern __s32 dsk_display_set_backcolor(__u32 de_color);
...
****************************************************************************************************
*/
extern __u32 dsk_display_get_backcolor(void);

...
#define 	MOVIE_SCAN_ALL  (MOVIE_SCAN_AVI|MOVIE_SCAN_MP4|MOVIE_SCAN_RMVB|MOVIE_SCAN_WMV)
#if 0
(MOVIE_SCAN_AVI | MOVIE_SCAN_MP4 /*| MOVIE_SCAN_MPG | MOVIE_SCAN_RM | MOVIE_SCAN_RM | MOVIE_SCAN_FLV | MOVIE_SCAN_PMP */\

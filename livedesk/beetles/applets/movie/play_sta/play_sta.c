...
void *movie_playsta_scene_create(movie_playsta_create_para_t *create_para)
{
    ...
    sence_para = (movie_playsta_scene_t *)esMEMS_Balloc(sizeof(movie_playsta_scene_t));
    if (!sence_para)
    {
    ...
    if (NULL == ui_para)
    {
        esMEMS_Bfree(sence_para, sizeof(movie_playsta_scene_t));
        sence_para = NULL;
...
__s32 movie_playsta_scene_delete(void *handle)
{
    ...
    esMEMS_Bfree(scene_para, sizeof(movie_playsta_scene_t));

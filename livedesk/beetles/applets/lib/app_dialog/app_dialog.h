...
enum
{
    ...
    ADLG_BMP_SZID_R_N,
    ADLG_BMP_SZID_R_Y,
    ADLG_BMP_SZID_SELECT,
    ADLG_BMP_SZID_BTN_Y,
    ADLG_BMP_SZID_BTN_NO,
    ADLG_BMP_SZID_STORAGE,
...
#define app_center_dialog_create(_h, _id, _wnd_s, _bmp, _str)  \
	app_dialog_create(_h, _id, (ADLG_TA_CENTER | ADLG_DS_VISIBLE | (_wnd_s)), _bmp, _str, 0,0)

#define default_dialog(_dialog, _parent, _id, _btn_s, _str)  do \
{\
	__s32 _bmp[] = {ID_DIALOG_MSGBOX_BMP, ID_DIALOG_MSGBOX_BTN_F_BMP, ID_DIALOG_MSGBOX_BTN_N_BMP, ID_DIALOG_ICON_INFORMATION_BMP,ID_DIALOG_MSGBOX_L_N_BMP,ID_DIALOG_MSGBOX_L_Y_BMP,ID_DIALOG_MSGBOX_R_N_BMP,ID_DIALOG_MSGBOX_R_Y_BMP,ID_DIALOG_MSGBOX_SELECT_BMP,ID_DIALOG_MSGBOX_BTN_YES_BMP,ID_DIALOG_MSGBOX_BTN_NO_BMP,ID_DIALOG_MSGBOX_STORAGE_BMP}; \
	_dialog = app_dialog_create(_parent, _id, (ADLG_TA_CENTER | ADLG_DS_VISIBLE | ADLG_MAKE_WND_STYLE(ADLG_ICONINFORMATION, _btn_s)), _bmp, _str, 0,1024); \
}while (0)

/*****************************************************************************************/


#define jh_default_dialog(_dialog, _parent, _id, _btn_s, _str,tans)  do \
{\
	__s32 _bmp[] = {ID_DIALOG_MSGBOX_BMP, ID_DIALOG_MSGBOX_BTN_F_BMP, ID_DIALOG_MSGBOX_BTN_N_BMP, ID_DIALOG_ICON_INFORMATION_BMP,ID_DIALOG_MSGBOX_L_N_BMP,ID_DIALOG_MSGBOX_L_Y_BMP,ID_DIALOG_MSGBOX_R_N_BMP,ID_DIALOG_MSGBOX_R_Y_BMP,ID_DIALOG_MSGBOX_SELECT_BMP,ID_DIALOG_MSGBOX_BTN_YES_BMP,ID_DIALOG_MSGBOX_BTN_NO_BMP,ID_DIALOG_MSGBOX_STORAGE_BMP}; \
	_dialog = app_dialog_create(_parent, _id, (ADLG_TA_CENTER | ADLG_DS_VISIBLE | ADLG_MAKE_WND_STYLE(ADLG_ICONINFORMATION, _btn_s)), _bmp, _str, 0,tans); \
}while (0)
...
{\
	__s32 _bmp[] = {ID_DIALOG_MSGBOX_BMP, ID_DIALOG_MSGBOX_BTN_F_BMP, ID_DIALOG_MSGBOX_BTN_N_BMP, ID_DIALOG_ICON_INFORMATION_BMP}; \

...
*********************************************************************************************************
*/
int eLIBs_vsnprintf(char *buffer, __size_t size, const char *format, va_list arg)
{
...
*********************************************************************************************************
*/
int eLIBs_vscnprintf(char *buffer, __size_t size, const char *format, va_list args)
{
    int i;
...
*********************************************************************************************************
*/
int eLIBs_snprintf(char *buffer, __size_t size, const char *format, ...)
{
    va_list args;
    int i;
...
*********************************************************************************************************
*/
int eLIBs_scnprintf(char *buffer, __size_t size, const char *format, ...)
{
    va_list args;
    int i;

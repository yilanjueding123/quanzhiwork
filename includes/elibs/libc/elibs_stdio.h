...
extern int eLIBs_fllseek(ES_FILE * /*stream*/, __s64 /*offset*/, int /*whence*/);
/*
 * sets the ES_FILE position indicator for the stream pointed to by stream.
 * For a binary stream, the new position is at the signed number of
 * characters specified by offset away from the point specified by whence.
...
extern int eLIBs_ferror(ES_FILE * /*stream*/);
/*
...
extern int eLIBs_closedir(ES_DIR * /*pDir*/);
/*
 * Returns: zero if the operation succeeds, nonzero if it fails.
 */
...
*********************************************************************************************************
*/
extern int eLIBs_vsnprintf(char *buffer, __size_t size, const char *format, va_list arg);
...
*********************************************************************************************************
*/
extern int eLIBs_vscnprintf(char *buffer, __size_t size, const char *format, va_list args);
...
*********************************************************************************************************
*/
extern int eLIBs_snprintf(char *buffer, __size_t size, const char *format, ...);
...
*********************************************************************************************************
*/
extern int eLIBs_scnprintf(char *buffer, __size_t size, const char *format, ...);
...
*******************************************************************************************************************
*/
extern int eLIBs_printf(const char *format, ...);

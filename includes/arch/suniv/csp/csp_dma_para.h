...
/* 下面两项基本上没有用，可以由DMA基础配置中的CONTINUOUS_ENABLE 或者DISABLE设置 */
...
//* DMA 等待时钟 */
#define	CSP_DMAC_CFG_WAIT_1_DMA_CLOCK				(0x00)	//(0x00<<26),1 clock
#define	CSP_DMAC_CFG_WAIT_2_DMA_CLOCK				(0x01)	//(0x01<<26),2 clock
#define	CSP_DMAC_CFG_WAIT_3_DMA_CLOCK				(0x02)	//(0x02<<26),4 clock
#define	CSP_DMAC_CFG_WAIT_4_DMA_CLOCK				(0x03)	//(0x03<<26),8 clock
#define	CSP_DMAC_CFG_WAIT_5_DMA_CLOCK				(0x04)	//(0x04<<26),16 clock
#define	CSP_DMAC_CFG_WAIT_6_DMA_CLOCK				(0x05)	//(0x05<<26),32 clock
#define	CSP_DMAC_CFG_WAIT_7_DMA_CLOCK				(0x06)	//(0x06<<26),64 clock
#define	CSP_DMAC_CFG_WAIT_8_DMA_CLOCK				(0x07)	//(0x07<<26),128 clock
...
#define	CSP_DMAC_CFG_DEST_TYPE_LCD   				(0x02)	//(0x02<<16)
#define	CSP_DMAC_CFG_DEST_TYPE_NFC  		    	(0x03)	//(0x03<<16)
#define	CSP_DMAC_CFG_DEST_TYPE_USB0			    	(0x04)	//(0x04<<16)
#define	CSP_DMAC_CFG_DEST_TYPE_SDC0			    	(0x06)	//(0x06<16)
#define	CSP_DMAC_CFG_DEST_TYPE_SDC2 				(0x08)	//(0x08<<16)
#define	CSP_DMAC_CFG_DEST_TYPE_AHB_MEM              (0x09)	//(0x09<<16)
...
#define	CSP_DMAC_CFG_SRC_TYPE_AUDIO_AD 				(0x0c)	//(0x0c<<0)
...
#define	CSP_DMAC_CFG_SRC_TYPE_SDC0			    	(0x06)	//(0x06<<0)
#define	CSP_DMAC_CFG_SRC_TYPE_SDC2 				    (0x08)	//(0x08<<0)
#define	CSP_DMAC_CFG_SRC_TYPE_AHB_MEM			    (0x09)	//(0x09<<0)
...
typedef struct  CSP_dma_config
{
    ...
    unsigned int      cmt_blk_cnt	   ; //只对DDMA有效，传输comity counter
} CSP_dma_config_t;

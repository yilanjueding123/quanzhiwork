...
* Date 			: 2009.09.10
*
* Description 	: 适用于 sun_20 平台, USB寄存器定义
*
* History 		:
*
********************************************************************************************************************
...
__u32 USBC_Phy_Write(__hdle hUSB, __u32 addr, __u32 data, __u32 len);
...
__u32 usb_phy_new_tp_write(__hdle hUSB, __u32 addr, __u32 data, __u32 len);
__u32 usb_phy_new_tp_read(__hdle hUSB, __u32 addr, __u32 len);
void UsbPhyEndReset(__hdle hUSB);
...
typedef int (* USBC_Print)(const char *format, ...);

void USBC_PrintEpReg(__hdle hUSB, __s32 ep_index, char *str, USBC_Print print);
void USBC_PrintUSBReg(__hdle hUSB, __s32 ep_start, __u32 ep_end, char *str, USBC_Print print);

...
typedef enum
{
    ...
    DSK_MSG_ORCHID_UPDATA_START,// 开始更新orchid
    DSK_MSG_ORCHID_UPDATA_END,	// 更新orchid 结束

    DSK_MSG_INSTALL_USBH,		// usb host 检测到device插入
    DSK_MSG_UNSTALL_USBH,		// usb host 检测到device

    DSK_MSG_SET_AUTO_OFF,		// 设置关机时间
    DSK_MSG_SET_SCR_CLOSE,		// 设置关屏时间

    DSK_MSG_SCREEN_OPEN,		// 通知开屏
    DSK_MSG_SCREEN_CLOSE,		// 通知关屏
    DSK_MSG_SCREEN_OP_GATE_ON,	// 禁止自动关屏
    DSK_MSG_SCREEN_OP_GATE_OFF,	// 允许自动关屏

...
struct usb_interface *usb_mod_to_usb_interface(struct usb_host_virt_sub_dev *sub_dev)
{
    if(!sub_dev)
    {
        DMSG_PANIC("PANIC : usb_dev_mod :: from virt_sub_dev to usb_interface input == NULL\n");
        return NULL;
    }
...
struct usb_host_virt_sub_dev *usb_mod_interface_to_virt_sub_dev(struct usb_interface *intf)
{
    if(!intf)
    {
        DMSG_PANIC("PANIC : usb_dev_mod :: from usb_interface to virt_sub_dev input == NULL\n");
        return NULL;
    }
...
struct usb_host_func_drv *usb_mod_interface_to_func_drv(struct usb_interface *intf)
{
    ...
    {
        DMSG_PANIC("PANIC : usb_dev_mod :: from usb_interface to func_drv :  intf->virt_sub_dev == NULL\n");
        return NULL;
    }
}
...
struct usb_host_virt_dev *usb_mod_interface_to_usbdev(struct usb_interface *intf)
{
    ...
    if(!intf)
    {
        DMSG_PANIC("PANIC : usb_mod_interface_to_usbdev () inft == NULL\n");
        return NULL;
    }
    virt_sub_dev = usb_mod_interface_to_virt_sub_dev(intf);
    if(!virt_sub_dev )
    {
        DMSG_PANIC("PANIC : usb_mod_interface_to_usbdev()  virt_sub_dev == NULL\n");
        return NULL;
    }
...
void *usb_mod_usb_get_intf_priv_data (struct usb_interface *intf)
{
    if(!intf)
    {
        DMSG_PANIC("PANIC : usb_mod_usb_get_intf_priv_data () inft == NULL\n");
        return NULL;
    }
    ...
    {
        DMSG_PANIC("PANIC : usb_mod_usb_get_intf_priv_data () intf->virt_sub_dev->drv_pirv_data == NULL\n");
        return NULL;
    }
...
void  usb_mod_usb_set_intf_priv_data (struct usb_interface *intf, void *data)
{
    ...
    if(!intf)
    {
        DMSG_PANIC("PANIC : usb_mod_usb_set_intf_priv_data () inft == NULL\n");
        return ;
    }
    ...
    {
        DMSG_PANIC("PANIC : usb_mod_usb_set_intf_priv_data () intf->virt_sub_dev->drv_pirv_data == NULL\n");
    }

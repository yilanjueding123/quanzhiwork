...
/* frame address */
typedef __packed struct _MSF_LBA
{
...
{
    __u32 TrackNumber;		/* Toc 所属的 track 	*/
    __u32 Format;			/* CD-ROM address types */
    __u32 Adr	: 4;		/* The type of information encode in the Q sub-channel of this blocks */
    __u32 Ctrl	: 4;		/* attributes of the track */

    MSF_LBA_t Address;		/* Toc entry address  	*/
    __u32 DataMode;			/* is a data track? 	*/
} CDROM_TocEntry_t;

typedef struct _CD_Rom
{
    /* 光驱的信息 */
    __u32 DriveType;					/* 光驱的型号 				*/
    __u32 MaxSpeed;						/* 光驱最大的速度 			*/
    __u32 CurrentSpeed;					/* 光驱当前的速度 			*/
    __u32 Readcd_cdda;					/* reading audio data using READ_CD */
    __u32 WriteAble;					/* 光驱是否支持写操作 		*/
    CDROM_Capitilities_t Capitilities;	/* 光驱的驱动能力			*/
    __u32 Eject;						/* 是否支持光驱退出 		*/
    __u32 PowerStatus;					/* 光驱电源状态. Active, Idle, Standby ? */

    /* 光碟信息 */
    __u32 DiscType;						/* 光碟的型号 				*/
    __u32 DoubleDisc;					/* 是否是双面光碟?	 		*/
    __u32 LastWriteSector;				/* 但前已经写的最后一个扇区 */
    __u32 MultiSession;					/* 多区段 					*/
    __u32 NumberOfSUinitPerMUnit;		/* MSF中每M保护的s个数 		*/
    __u32 NumberOfFUinitPerSUnit;		/* MSF中每S保护的F个数 		*/
    __u32 InactivityTimeMultiPlier;		/*							*/

    /* 光驱管理 */
    __u32 DriveStatus;					/* 光驱状态 				*/
    __u32 IsMeduimPrevent;    			/* 是否设置禁止介质移动 	*/
} CD_Rom_t;

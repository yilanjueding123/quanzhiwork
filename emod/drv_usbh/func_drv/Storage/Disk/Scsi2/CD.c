...
*******************************************************************************
*/
__u32 CdIOCtrlLastWriteSector(__UsbBlkDev_t *BlkDev)
{
    CD_Rom_t *CD = NULL;
...
*******************************************************************************
*/
__u32 CdIOCtrlMultiSession(__UsbBlkDev_t *BlkDev)
{
    return 0;
}
...
*/
#if 0
static __s32 GetCdLastWriteSector(__mscLun_t *mscLun, CD_Rom_t *CD)
{
    ...
    USB_OS_MEMSET(&DiscInfo,  0, sizeof(CDROM_DiscInfo_t));
    USB_OS_MEMSET(&TrackInfo, 0, sizeof(CDROM_TrackInfo_t));
    USB_OS_MEMSET(buffer,  0, MAXIMUM_CDROM_SIZE);
...
__s32 CDIOCtrl(__UsbBlkDev_t *BlkDev, __u32 Cmd, __s32 Aux, void *pBuffer)
{
...
static void GetCDDriveCapabilites(__mscLun_t *mscLun, CD_Rom_t *CD)
{
    ...
    __u32 ActLen 		= 0;
    __s32 ret 			= 0;
    __u32 pageAddr 		= 0;   /* Capitilities页起始地址 */
    ...
    if(ActLen)
    {
        ...
        USB_OS_MEMCPY(&(CD->Capitilities), Capitilities, sizeof(CDROM_Capitilities_t));
...
static void GetCDDiscTpye(__mscLun_t *mscLun, CD_Rom_t *CD)
{
    ...
    __u32 ActLen 		= 0;
    __s32 ret 			= 0;
    __u32 pageAddr  	= 0;   /* CDROM page 页起始地址 */
    __ModeSense10Header_t *Header = NULL;
...
*/
#if 0
static __s32 GetCDRomPowerEvent(__mscLun_t *mscLun, CD_Rom_t *CD, CDROM_PowerStatus_t *PowerStatus)
{
    ...
    USB_OS_MEMSET(buffer, 0, CDROM_GET_EVENT_CMD_MAX_RETURN_DATA_LEN);
    ...
    USB_OS_MEMCPY(PowerStatus, buffer + sizeof(CDROM_EventHeader_t) , sizeof(CDROM_PowerStatus_t));
...
*******************************************************************************
*/
static __s32 GetCDRomMediaEvent(__mscLun_t *mscLun, CD_Rom_t *CD, CDROM_MediaStatus_t *MediaStatus)
{
    __u8  buffer[CDROM_GET_EVENT_CMD_MAX_RETURN_DATA_LEN];
    __s32 ret    = 0;
    CDROM_EventHeader_t *EventHeader = NULL;
    ...
    USB_OS_MEMCPY(MediaStatus, buffer + sizeof(CDROM_EventHeader_t) , sizeof(CDROM_MediaStatus_t));
...
*******************************************************************************
*/
static __s32 GetCDRomDriveEvent(__mscLun_t *mscLun, CD_Rom_t *CD)
{
    ...
    USB_OS_MEMSET(&MediaStatus, 0, sizeof(CDROM_MediaStatus_t));
...
*******************************************************************************
*/
__u32 ReadCDDA(__mscLun_t *mscLun, __u32 Lba, __u32 nFrames, void *Buffer)
{
    return 0;
}
...
__s32 CDProbe(__mscLun_t *mscLun)
{
    ...
    CD = USB_OS_MALLOC(sizeof(CD_Rom_t), USB_MEM_FILE_TRIGGER, USB_MEM_LINE_TRIGGER);
    if(CD == NULL)
    {
    ...
    USB_OS_MEMSET(CD, 0, sizeof(CD_Rom_t));

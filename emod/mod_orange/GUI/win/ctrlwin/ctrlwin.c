...
__u32  GUI_CtrlWinGetAddData (H_WIN hWnd)
{
    ...
    return (__u32)pWidget->dwAddData;
}
...
__s32  GUI_CtrlWinSetAddData (H_WIN hWnd, __u32 dwAddData)
{
    __gui_win_t         *pWin       = GUI_WinH2P(hWnd);
    __gui_widget_t      *pWidget    = (__gui_widget_t *)pWin;
    ...
    pWidget->dwAddData  = (__u32)dwAddData;
...
H_WIN  GUI_CtrlWinCreate (__gui_ctlwincreate_para_t *create_info)
{
    ...
    /*send message to win to create private data*/
    {
        ...
        new_msg.dwAddData1  = (__u32)pNewCtrl->base_win.Parent;
        new_msg.dwAddData2  = (__u32)create_info->attr;
        new_msg.p_arg       = 0;

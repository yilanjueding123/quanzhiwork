...
extern  __s32 GUI_LogicLayerSetScnWin(__u8 dir, ES_FILE *disp_handle, __hdle hlayer, __rect_t *rect);

extern  __s32 GUI_LogicLayerSetSrcWin(__u8 dir, ES_FILE *disp_handle, __hdle hlayer, __rect_t *rect);

extern  __s32 GUI_LogicLayerSetPara(__u8 dir, ES_FILE *disp_handle, __hdle hlayer, __disp_layer_para_t *player);

extern  __s32 GUI_LogicLayerRequest(__u8 dir, ES_FILE *disp_handle, __hdle hlayer, __disp_layer_para_t *player);

extern  __s32 GUI_LogicLayerSetFb(__u8 dir, ES_FILE *disp_handle, __hdle hlayer, FB *pfb);

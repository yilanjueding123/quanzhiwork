...
__s32 GUI_WinSetAttr(H_WIN hWnd, void *attr)
{
    ...
    GUI_WinLock();
    (GUI_WinH2P(hWnd))->dwAddData = (__u32)attr;
    GUI_WinUnlock();
...
__s32  GUI_WinSetAddData (H_WIN hWnd, __u32 dwAddData)
{
    ...
    pWin->dwCtrlData  = (__u32)dwAddData;
...
__u8    GUI_WinGetWinThreadId(H_WIN  hWnd)
{
    __gui_win_t     *pWin = GUI_WinH2P(hWnd);
...
void GUI_NotifyParent (__gui_notify_msg_t *msg)
{
    ...
    else
    {
        ...
        notifymsg.h_srcwin  = (__u32)msg->hWnd;

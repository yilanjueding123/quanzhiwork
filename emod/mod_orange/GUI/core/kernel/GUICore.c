...
static void _InitContext(GUI_CONTEXT *pContext)
{
    ...
    // #endif
    //pContext->pClipRect_HL[GUI_Context.SelLayer] = NULL;  //mcl del 08.11.25

#if GUI_SUPPORT_DEVICES
    pContext->pDeviceAPI   = LCD_aAPI[1]; /* &LCD_L0_APIList; */  // layer  mcl  aRGB 08.11.25
#endif
    pContext->pClipRect_HL[GUI_Context.SelLayer] = &GUI_Context.ClipRect[GUI_Context.SelLayer];
    LCD_L0_GetRect(&pContext->ClipRect[GUI_Context.SelLayer]);
...
int GUI_Kernel_Init(void)
{
    ...
    GUI_Context.SelLayer = 0xFFFFFFFF; //mcl add   sel layer 0

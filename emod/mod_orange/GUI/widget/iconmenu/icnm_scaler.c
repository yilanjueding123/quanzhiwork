...
__s32 ICNM_Scaler(__lion_icnm_icon_t *desicon, __lion_icnm_icon_t *srcicon)
{
    ...
    h_scaler = eLIBs_fioctrl(p_disp, DISP_CMD_SCALER_REQUEST, SEL_SCREEN, 0); //modified by Derek,2010-12-9 19:35:03
    if(!h_scaler)
    {
    ...
    dispbuffer[1] = 0;
    dispbuffer[2] = 0;
    eLIBs_fioctrl(p_disp, DISP_CMD_SCALER_RELEASE, SEL_SCREEN, (void *)dispbuffer); //end modified

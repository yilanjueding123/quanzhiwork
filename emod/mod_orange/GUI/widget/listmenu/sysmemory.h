...
//#define MEM_INIT(size,minsize)    MEMINIT(size, minsize)
...
//#define MEM_PMALLOC(size)           (void*)0x100;
//#define MEM_PFREE(ptr,size)
//#define MEM_UNINIT                MEMUNINIT
#define sysmemcpy                 eLIBs_memcpy
#else

#error "EPDK_OS not defined yet !"

...
typedef struct ORANGEMOD_API_ENTRY
{
    ...
    __u32             (*ptr_GUI_WinGetAddData          )(H_WIN hWnd);                               /*得到某个窗口的私有控制信息属性*/
    __s32             (*ptr_GUI_WinSetAddData          )(H_WIN hWnd, __u32 dwAddData);              /*设置某个窗口的私有控制信息属性*/
    ...
    GUI_RECT         *(*ptr_GUI_SetClipRect)(const GUI_RECT *pRect);     //mcl  2008.12.18
    ...
    GUI_FONT         *(*ptr_GUI_SetFont)(const GUI_FONT GUI_UNI_PTR *pNewFont);
    ...
    __u32             (*ptr_GUI_CtrlWinGetAddData      )(H_WIN hWnd);                               /*获取control的附加数据*/
    __s32             (*ptr_GUI_CtrlWinSetAddData      )(H_WIN hWnd, __u32 dwAddData);              /*设置control的附加数据*/
    ...
    __u32             (*ptr_GUI_LstmGetItemAttr     )(H_WIN H_Item);
    ...
    __u32             (*ptr_SListbox_GetItemAttr		  )(h_listboxitem H_Item);
    ...
    void 			  (*ptr_GUI_Memdev_FrameBuffer_Release)(void);
    U32				  (*ptr_GUI_SetFrameColor32bpp)(U32 frameColor);

} orangemod_api_entry_t;

#ifndef USED_BY_ORANGEMOD	//not used by orangemod module itsef
#define ORANGEMOD_ENTRY_TBL   (0xe1800000)   //this address is depended on the link address of mod_orangemod

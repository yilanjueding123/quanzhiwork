...
//    lcdpwm_hdl = OSAL_GPIO_Request(&gpio_set, 1);
}
...
//	if(lcdpwm_hdl != NULL)
//	{
//		OSAL_GPIO_Release(lcdpwm_hdl, 0);
//		lcdpwm_hdl = 0;
//	}
}
...
static void LCD_bl_io_init(__u32 sel)
{
	...
	lcdpwm_hdl = OSAL_GPIO_Request(&gpio_set, sel);
}
...
static void  LCD_io_init(__u32 sel)
{
    ...
    lcdcs_hdl = OSAL_GPIO_Request(&gpio_set, 1);
}
